...
namespace Forex_Strategy_Builder
{
    ...
    public class Oscillator_of_OBOS : Indicator
    {
        ...
        /// </summary>
        public Oscillator_of_OBOS(IDataSet dataSet, SlotTypes slotType)
            : base(dataSet)
        {
            // General properties
...
// ---------------------------------------------------------
            Overbought_Oversold_Index OBOS1 = new Overbought_Oversold_Index(DataSet, slotType);
            ...
            Overbought_Oversold_Index OBOS2 = new Overbought_Oversold_Index(DataSet, slotType);
